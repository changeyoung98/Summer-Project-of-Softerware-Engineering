...
def format_filename_basic(time,camera_id,pic_id):
    ret = str(time) + "_" + camera_id + "_" + str(pic_id)
    return ret
...
def format_filename(time,camera_id,pic_id,count):
    ret = str(time) + "_" + camera_id + "_" + str(pic_id) + "_" + str(count) + ".jpg"
    return ret
