...
class VideoPlayer extends Component{
	...
	render(){
        ...
        <Icon type="play-circle-o" />
				<video width="100%" height="100%" autoPlay="autoPlay" poster="none" id="myVideo" onClick={this.playPause.bind(this)} onMouseMove={ this.toggleControlBar.bind(this)} onMouseLeave={this.toggleControlBar.bind(this)}>
          ...
          <span><i className="fa fa-caret-right"/></span>
             ...
             style={{visibility: this.state.progress === '100%' || this.state.showControlBar ? 'visible':'hidden',opacity: this.state.progress || this.state.showControlBar ? 1:0}}>
